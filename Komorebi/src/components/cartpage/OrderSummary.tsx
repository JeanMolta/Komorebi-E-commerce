...
const OrderSummary: React.FC = () => {
  ...
  return (
    <div className="bg-[var(--komorebi-offwhite)] rounded-3xl p-6 shadow-sm border border-gray-100 h-fit">
      ...
      <div className="space-y-4">
        ...
        <button
          ...
          className={`w-full py-4 rounded-4xl font-semibold transition-all mt-6 ${
            itemCount === 0
