  ...
  return (
    <section className="relative h-screen w-full">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6 sm:px-12">
        ...
        <button className="bg-[var(--komorebi-yellow)]/100 border border-white/20 shadow-sm text-[var(--komorebi-black)] px-6 py-3 rounded-full hover:bg-[var(--komorebi-yellow)]/95 transition-colors font-bold">
          Shop Now
        </button>
      </div>
    </section>
